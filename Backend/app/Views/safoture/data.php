                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($r->status_konfirmasi == 0) : ?>
                                                        <a href="/safoture/edit/<?= $r->id ?>" class="badge bg-gradient-blue">Edit</a>
                                                        <a href="#" class="badge bg-gradient-red" data-toggle="modal" data-target="#modal-default<?= $r->id ?>">Delete</a>
                                                    <?php elseif ($r->status_konfirmasi == 2) : ?>
                                                        <a href="#" class="badge bg-gradient-danger">Failed</a>
                                                    <?php else : ?>
                                                        <a href="#" class="badge bg-gradient-success">Success</a>
                                                    <?php endif; ?>
                                                </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Data Safoture</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/safoture/delete" method="POST">
                    <?= csrf_field(); ?>
